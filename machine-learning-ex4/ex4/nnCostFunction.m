...
%the theta 10285 elems correspond to the ((input_layer_size(400) + 1) * hidden_layer_size (25)) +  (( hidden_layer_size (25) + 1) * num_labels(10))
%we have to roll all the input to multiply with nm that is
%1 + x 
%1 + hidden * output
a1 = [ones(m,1) X];
